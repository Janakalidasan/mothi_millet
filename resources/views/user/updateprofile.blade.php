...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xl-8 mt-4">
            <p style="color:#DB4444" >Update Profile</p>
            <form>
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6">
                        <div class="mb-3">
                            <label for="examplefirstname" class="form-label" style="color:#fff">First Name</label>
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label" style="color:#fff">Phone</label>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6">
                        <div class="mb-3">
                            <label for="examplelastname" class="form-label" style="color:#fff">Last Name</label>
                            <input type="text" class="form-control" id="examplelastname" aria-describedby="emailHelp"
                                placeholder="Enter last name">
                        </div>
                        <div class="mb-3">
                            <label for="exampleadress" class="form-label" style="color:#fff">Address</label>
                            <input type="tex" class="form-control" id="exampleadress" aria-describedby="emailHelp"
                                placeholder="Enter Address">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label" style="color:#fff">Alt-Phone</label>
                            <input type="telegam" class="form-control" id="exampleInputEmail1"
                ...
                <div class="d-flex justify-content-end align-items-center">
                    <a href="#" class="btn btn-danger" style="text-decoration:none; color:#fff;"><i class="fas fa-times"></i> Cancel</a>&nbsp;&nbsp;
                    <a href="#" class="btn btn-success"><i class="fas fa-save"></i> update Profile</a>
                </div>
            </form>
        </div>
    </div>
